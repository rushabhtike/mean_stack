...
describe('Component: App', () => {
  ...
  it('should display the navigation bar correctly for guests', () => {
    ...
    //expect(de[1].nativeElement.textContent).toContain('Quotes');
    ...
    //expect(de[1].attributes['routerLink']).toBe('/quotes');
